<template>
  ...
  <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
   <el-form-item label="穴盘类型" prop="plugTypeId">
        <el-select v-model="queryParams.plugTypeId" placeholder="请选择穴盘类型" clearable size="small">
          <el-option
       ...
       <el-form-item label="产地" prop="originPlace">
        <el-select v-model="form.originPlace" placeholder="请选择产地" clearable size="small">
...
import { listPlugpurchaseApply, getPlugpurchaseApply, delPlugpurchaseApply, addPlugpurchaseApply, updatePlugpurchaseApply, exportPlugpurchaseApply } from "@/api/production/plug/purchaseApply";
...
orderByColumn:"create_time",
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有穴盘购买申请数据项?', "提示", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
