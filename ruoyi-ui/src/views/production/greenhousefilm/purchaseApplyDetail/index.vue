  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="棚膜类型" prop="greenhousefilmTypeId">
        <el-select v-model="queryParams.greenhousefilmTypeId" placeholder="请选择棚膜类型" clearable size="small">
          <el-option
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:greenhousefilmpply:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleUpdate"
          v-hasPermi="['system:greenhousefilmpply:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-table v-loading="loading" :data="greenhousefilmpplyList" @selection-change="handleSelectionChange">
...
import { listGreenhousefilmpply, getGreenhousefilmpply, delGreenhousefilmpply, addGreenhousefilmpply, updateGreenhousefilmpply, exportGreenhousefilmpply } from "@/api/production/greenhousefilm/purchaseApply";
  ...
  methods: {
    ...
    formdata_type(data){
      ...
      this.greenhousefilm_type.forEach(type =>{
        greenhousefilm_type_map.set(type.greenhousefilmTypeId,type.greenhousefilmType)
      })
      data.forEach(type => {
        let greenhousefilm_name = greenhousefilm_type_map.get(type.greenhousefilmTypeId)
    ...
    handleUpdate(row) {
      this.reset();
      const greenhousefilmPurchaseApplyId = row.greenhousefilmPurchaseApplyId || this.ids
    ...
    handleDelete(row) {
      ...
      const greenhousefilmPurchaseApplyIds = row.greenhousefilmPurchaseApplyId || this.ids;
      this.$confirm('是否确认删除该棚膜购买申请?', "提示", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
          return delGreenhousefilmpply(greenhousefilmPurchaseApplyIds).then(response =>{
