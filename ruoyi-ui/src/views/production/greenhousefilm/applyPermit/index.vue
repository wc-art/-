        ...
        <template slot-scope="scope">
          ...
          <div style="display: flex">
            <el-button
              ...
              v-hasPermi="['greenhousefile:apply:permit1']"
              >通过</el-button
            >
            <el-button
              v-bind:disabled="setpassBtn1(scope.row)"
        ...
        <template slot-scope="scope">
          ...
          <div style="display: flex">
            <el-button
              ...
              v-hasPermi="['greenhousefile:apply:permit2']"
              >通过</el-button
            >
            <el-button
              v-bind:disabled="setpassBtn2(scope.row)"
...
export default {
  ...
  methods: {
    ...
    handleThroughProduct(row) {
      ...
      let data = {};
      data.greenhousefilmApplyId = greenhousefilmApplyId;
    ...
    handleExport() {
      ...
      this.$confirm("是否确认导出所有棚膜申请数据项?", "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning",
      })
