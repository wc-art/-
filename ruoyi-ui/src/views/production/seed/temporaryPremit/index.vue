        ...
        <template slot-scope="scope">
          ...
          <div style="display: flex">
            <el-button
              ...
              v-hasPermi="['seed:temporary:permit1']"
              >通过</el-button
            >
            <el-button
              v-bind:disabled="setpassBtn1(scope.row)"
        ...
        <template slot-scope="scope">
          ...
          <div style="display: flex">
            <el-button
              ...
              v-hasPermi="['seed:temporary:permit2']"
              >通过</el-button
            >
            <el-button
              v-bind:disabled="setpassBtn2(scope.row)"
  ...
  methods: {
    ...
    handleThroughProduct(row) {
      ...
      this.$confirm("是否确认通过该种子审核?", "提示", {
        ...
        .then(function () {
          return updateTemporary(data).then((response) => {
    ...
    handleDelete(row) {
      ...
      this.$confirm("是否确认删除该种子申请?", "提示", {
        ...
        .then(function () {
          return getTemporary(seedApplyIds).then((response) => {
    ...
    handleExport() {
      ...
      this.$confirm("是否确认导出所有种子申请数据项?", "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning",
      })
