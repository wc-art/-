...
import { listApply, getApply, delApply, addApply, updateApply, exportApply } from "@/api/production/seed/applyDetail";
...
orderByColumn:"create_time",
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除该种子购买申请?', "提示", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
          return delApply(seedPurchaseApplyIds).then(response =>{
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有种子购买申请数据项?', "提示", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
