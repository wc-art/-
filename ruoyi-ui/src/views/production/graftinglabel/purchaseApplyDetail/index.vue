<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="嫁接签类型" prop="graftinglabelTypeId" label-width="85px">
        <el-select v-model="queryParams.graftinglabelTypeId" placeholder="请选择类型" clearable size="small">
          <el-option
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:graftinglabelApply:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleUpdate"
          v-hasPermi="['system:graftinglabelApply:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-table v-loading="loading" :data="graftinglabelApplyList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="编号" align="center" type="index" />
      <el-table-column label="嫁接签类型" align="center" prop="graftinglabelType"  width="90px"/>
      <el-table-column label="规格" align="center" prop="graftinglabelSpecification" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="嫁接签类型" prop="graftinglabelTypeId">
          <el-select v-model="form.graftinglabelTypeId" placeholder="请选择类型" clearable size="small">
            <el-option
              v-for="type in graftinglabels_type"
              :key="type.graftinglabelTypeId"
              :value="type.graftinglabelTypeId"
...
import { listGraftinglabelApply, getGraftinglabelApply, delGraftinglabelApply, addGraftinglabelApply, updateGraftinglabelApply, exportGraftinglabelApply } from "@/api/production/graftinglabel/purchaseApply";
...
orderByColumn:"create_time",
  ...
  methods: {
    ...
    handleUpdate(row) {
      this.reset();
      const graftinglabelPurchaseApplyId = row.graftinglabelPurchaseApplyId || this.ids
    ...
    handleDelete(row) {
      ...
      const graftinglabelPurchaseApplyIds = row.graftinglabelPurchaseApplyId || this.ids;
      this.$confirm('是否确认删除该嫁接签购买申请?', "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning"
      }).then(function() {
        return delGraftinglabelApply(graftinglabelPurchaseApplyIds).then(response =>{
