    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="规格" prop="graftinglabelSpecification">
          ...
          >
            <el-option
              v-for="item in graftinglabel_amount"
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      const graftinglabelApplyTemporaryIds =
        row.graftinglabelApplyTemporaryId || this.ids;
      this.$confirm("是否确认删除该嫁接签临时申请领用详细?", "提示", {
    ...
    handleExport() {
      ...
      this.$confirm("是否确认导出所有嫁接签临时申请领用详细数据项?", "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning",
      })
