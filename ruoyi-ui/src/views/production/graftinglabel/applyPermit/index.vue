<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="库存量" align="center" prop="graftinglabelTypeId">
        <template slot-scope="scope">
          <span>{{
            (graftinglabelAmountList.filter(
              (item) =>
        ...
        <template slot-scope="scope">
          ...
          <div style="display: flex">
            <el-button
              ...
              v-hasPermi="['graftinglabel:apply:permit1']"
              >通过</el-button
            >
            <el-button
              v-bind:disabled="setpassBtn1(scope.row)"
        ...
        <template slot-scope="scope">
          ...
          <div style="display: flex">
            <el-button
              ...
              v-hasPermi="['graftinglabel:apply:permit2']"
              >通过</el-button
            >
            <el-button
              v-bind:disabled="setpassBtn2(scope.row)"
...
export default {
  ...
  created() {
    ...
    Promise.all([
      ...
      this.getGraftinglabelAmountList(),
    ]).then((res) => {
      this.getList();
    });
  },
  ...
  methods: {
    ...
    handleThroughProduct(row) {
      ...
      let data = {};
      data.graftinglabelApplyId = graftinglabelApplyId;
    ...
    handleExport() {
      ...
      this.$confirm("是否确认导出所有嫁接签申请数据项?", "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning",
      })
