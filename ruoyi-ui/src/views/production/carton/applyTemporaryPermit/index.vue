<template>
  <div class="app-container">
        ...
        <template slot-scope="scope">
          ...
          <div style="display: flex">
            <el-button
              ...
              v-hasPermi="['carton:applyTemporary:permit1']"
              >通过</el-button
            >
            <el-button
              v-bind:disabled="setpassBtn1(scope.row)"
        ...
        <template slot-scope="scope">
          ...
          <div style="display: flex">
            <el-button
              ...
              v-hasPermi="['carton:applyTemporary:permit2']"
              >通过</el-button
            >
            <el-button
              v-bind:disabled="setpassBtn2(scope.row)"
    ...
    <!--        <el-form-item label="规格" prop="cartonSpecification">-->
    <!--          <el-input v-model="form.cartonSpecification" placeholder="请输入纸箱品牌" />-->
    <!--        </el-form-item>-->
...
export default {
  ...
  methods: {
    ...
    handleThroughProduct(row) {
      ...
      let data = {};
      data.cartonApplyTemporaryId = cartonApplyTemporaryId;
