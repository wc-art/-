  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="纸箱类型" prop="cartonType">
        <el-select v-model="queryParams.cartonType" placeholder="请选择纸箱类型" clearable size="small">
          <el-option
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="纸箱编号" align="center" type="index" />
...
<script>
import { listType, getType, delType, addType, updateType, exportType } from "@/api/production/carton/type";
...
orderByColumn:"create_time",
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有纸箱类型数据项?', "提示", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
