<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="库存量" align="center" prop="pesticideTypeId">
        <template slot-scope="scope">
          <span>{{
            (pesticideAmountList.filter(
              (item) =>
                item.pesticideTypeId == scope.row.pesticideTypeId &&
                item.pesticideNameId == scope.row.pesticideNameId &&
        ...
        <template slot-scope="scope">
          ...
          <div style="display: flex">
            <el-button
              ...
              v-hasPermi="['pesticide:applyTemporary:permit1']"
              >通过</el-button
            >
            <el-button
              v-bind:disabled="setpassBtn1(scope.row)"
        ...
        <template slot-scope="scope">
          ...
          <div style="display: flex">
            <el-button
              ...
              v-hasPermi="['pesticide:applyTemporary:permit2']"
              >通过</el-button
            >
            <el-button
              v-bind:disabled="setpassBtn2(scope.row)"
    ...
    <!--          <el-select v-model="form.pesticideTypeId" placeholder="请选择农药类型" clearable size="small">-->
    <!--            <el-option-->
    <!--              v-for="type in pesticide_type"-->
    <!--              :key="type.pesticideTypeId"-->
    <!--              :value="type.pesticideTypeId"-->
    ...
    <!--          <el-select v-model="form.pesticideNameId" placeholder="请选择农药名称" clearable size="small">-->
    <!--            <el-option-->
    <!--              v-for="name in pesticide_name"-->
    <!--              :key="name.pesticideNameId"-->
    <!--              :value="name.pesticideNameId"-->
...
export default {
  ...
  methods: {
    ...
    handleThroughProduct(row) {
      ...
      let data = {};
      data.pesticideApplyTemporaryId = pesticideApplyTemporaryId;
      data.approvalStatusProduct = 1;
      this.$confirm("是否确认通过该农药审核?", "提示", {
    ...
    handleExport() {
      ...
      this.$confirm("是否确认导出所有农药临时申请数据项?", "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning",
      })
