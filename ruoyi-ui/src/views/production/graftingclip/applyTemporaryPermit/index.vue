        ...
        <template slot-scope="scope">
          ...
          <div style="display: flex">
            <el-button
              ...
              v-hasPermi="['graftingclip:applyTemporary:permit1']"
              >通过</el-button
            >
            <el-button
              v-bind:disabled="setpassBtn1(scope.row)"
        ...
        <template slot-scope="scope">
          ...
          <div style="display: flex">
            <el-button
              ...
              v-hasPermi="['graftingclip:applyTemporary:permit2']"
              >通过</el-button
            >
            <el-button
              v-bind:disabled="setpassBtn2(scope.row)"
...
export default {
  ...
  methods: {
    ...
    handleThroughProduct(row) {
      ...
      let data = {};
      data.graftingclipApplyTemporaryId = graftingclipApplyTemporaryId;
    ...
    handleDelete(row) {
      ...
      const graftingclipApplyTemporaryIds =
        row.graftingclipApplyTemporaryId || this.ids;
      this.$confirm("是否确认删除该嫁接夹临时申请?", "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning",
      })
    ...
    handleExport() {
      ...
      this.$confirm("是否确认导出所有嫁接夹临时申请数据项?", "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning",
      })
