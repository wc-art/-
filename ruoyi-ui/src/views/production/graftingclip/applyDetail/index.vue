    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="口径型号" prop="graftingclipSpecification">
          ...
          >
            <el-option
              v-for="(item, index) in graftingclip_amount"
              :key="index"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm("是否确认删除该嫁接夹申请领用详细?", "提示", {
    ...
    handleExport() {
      ...
      this.$confirm("是否确认导出所有嫁接夹申请领用详细数据项?", "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning",
      })
