  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch"  label-width="85px">
      <el-form-item label="嫁接夹类型" prop="graftingclipTypeId">
        <el-select v-model="queryParams.graftingclipTypeId" placeholder="请选择类型" clearable size="small">
          <el-option
      ...
      <el-form-item label="产地" prop="originPlace">
        <el-select v-model="queryParams.originPlace" placeholder="请选择产地" clearable size="small">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:graftingclipApply:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleUpdate"
          v-hasPermi="['system:graftingclipApply:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-table v-loading="loading" :data="graftingclipApplyList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="编号" align="center" type="index" />
      <el-table-column label="嫁接夹类型" align="center" prop="graftingclipType" width="90px"/>
      <el-table-column label="产地" align="center" prop="originPlace" />
      <el-table-column label="口径型号" align="center" prop="graftingclipSpecification" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="嫁接夹类型" prop="graftingclipTypeId">
          <el-select v-model="form.graftingclipTypeId" placeholder="请选择类型" clearable size="small">
            <el-option
              v-for="type in graftingclips_type"
              :key="type.graftingclipTypeId"
              :value="type.graftingclipTypeId"
...
import { listGraftingclipApply, getGraftingclipApply, delGraftingclipApply, addGraftingclipApply, updateGraftingclipApply, exportGraftingclipApply } from "@/api/production/graftingclip/purchaseApply";
...
orderByColumn:"create_time",
  ...
  methods: {
    ...
    handleUpdate(row) {
      this.reset();
      const graftingclipPurchaseApplyId = row.graftingclipPurchaseApplyId || this.ids
    ...
    handleDelete(row) {
      ...
      const graftingclipPurchaseApplyIds = row.graftingclipPurchaseApplyId || this.ids;
      this.$confirm('是否确认删除该嫁接夹购买申请?', "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning"
      }).then(function() {
        return delGraftingclipApply(graftingclipPurchaseApplyIds).then(response =>{
