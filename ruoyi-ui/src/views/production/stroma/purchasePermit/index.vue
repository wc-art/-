    ...
    >
      ...
      <el-form-item label="审批状态" prop="approvalStatus">
        <el-select
          ...
          placeholder="请选择审批状态0表示申请，1表示审批通过，2表示不通过"
          clearable
          size="small"
        >
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['system:stromapurchaseApply:permit']"
            >通过</el-button
          >
          <el-button
            v-bind:disabled="setpassBtn1(scope.row)"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm("是否确认删除该基质购买申请信息?", "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning",
      })
        .then(function () {
          return delStromapurchaseApply(stromaPurchaseApplyIds).then(
            (response) => {
