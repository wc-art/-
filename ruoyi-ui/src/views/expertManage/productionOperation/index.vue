<template>
  <div class="app-container">
    ...
    <add-or-update :title="title" :open="open" :form="form" :rules="rules" @reset="reset" @cancel="cancel"
      @getList="getList" categoryName="生产操作规程" from="expert_production"></add-or-update>

    <detailed title="生产操作规程详情" :openDetailed="openDetailed" :form="form" @cancelDetailed="cancelDetailed"
      categoryName="生产操作规程" from="expert_production"></detailed>
  </div>
</template>

<script>
  import { listProduction, getProduction, delProduction } from "@/api/expertManage/production";
...
orderByColumn:"create_time",
    ...
    methods: {
      ...
      handleDelete(row) {
        ...
        this.$confirm('是否确认删除生产操作规程序号为"' + xh + '"的数据项?', "警告", {
