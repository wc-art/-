  ...
  <div class="app-container">
    ...
    >
      <el-form-item label="标题" prop="expertdbTitle">
        <el-input
          v-model="queryParams.expertdbTitle"
          placeholder="请输入标题"
          clearable
          size="small"
      ...
      <el-form-item label="简介" prop="expertdbBriefIntroduction">
        <el-input
          v-model="queryParams.expertdbBriefIntroduction"
          placeholder="请输入简介"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['expertManage:seedlingQuality:add']"
          >新增</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['expertManage:seedlingQuality:edit']"
          >修改</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['expertManage:seedlingQuality:remove']"
          >删除</el-button
        >
      </el-col>
      <right-toolbar
    ...
    >
      ...
      <el-table-column
        label="简介"
        align="center"
        prop="expertdbBriefIntroduction"
      />
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['expertManage:seedlingQuality:detailed']"
            >详情</el-button
          >
          <el-button
            size="mini"
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getProduction(expertIds).then((response) => {
    ...
    handleDelete(row) {
      ...
      this.$confirm(
        ...
        .then(function () {
          return delProduction(expertIds);
        })
        .then(() => {
          this.getList();
    ...
    handleDetailed(row) {
      ...
      getProduction(expertId).then((response) => {
        this.form = response.data;
