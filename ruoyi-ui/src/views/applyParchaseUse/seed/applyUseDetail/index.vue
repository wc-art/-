  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="70px">
      <el-form-item label="订单分配表" prop="orderAllocationId" label-width = '85px'>
        <el-select v-model="queryParams.orderAllocationId" placeholder="请选择类型" clearable size="small">
          <el-option
      ...
      <el-form-item label="领用状态" prop="consumeStatus">
        <el-select v-model="queryParams.consumeStatus" placeholder="请选择领用状态" clearable size="small">
    ...
    <el-table v-loading="loading" :data="applyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="订单分配表编号" align="center" prop="orderAllocationId" />
      ...
      <el-table-column label="生产厂长审批状态" align="center" prop="approvalStatusProduct" >
        <template slot-scope="scope">
          <span>
      ...
      <el-table-column label="技术厂长审批状态" align="center" prop="approvalStatusTechnology" >
        <template slot-scope="scope">
          <span>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="订单名称" prop="orderAllocationId" >
...
<script>
import { listApply, getApply, delApply, addApply, updateApply, exportApply } from "@/api/applyParchaseUse/seed/apply";
...
orderByColumn:"create_time",
      ...
      rules: {
        orderAllocationId: [
          { required: true, message: "外码来自order_allocation订单分配表不能为空", trigger: "blur" }
        ],
        cropTypeId: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除种子申请编号为"' + seedApplyIds + '"的数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
          return delApply(seedApplyIds);
        }).then(() => {
          this.getList();
