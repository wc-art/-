<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="applyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="生产厂长审批" align="center" prop="approvalStatusProduct" >
        <template slot-scope="scope">
          <span>
      ...
      <el-table-column label="技术厂长审批" align="center" prop="approvalStatusTechnology" >
        <template slot-scope="scope">
          <span>
...
<script>
import { listTemporary, getTemporary, delTemporary, addTemporary, updateTemporary, exportTemporary } from "@/api/applyParchaseUse/seed/temporary";
...
orderByColumn:"create_time",
  ...
  methods: {
    ...
    handleDelete(row) {
      const seedApplyTemporaryId = row.seedApplyTemporaryId || this.ids;
      this.$confirm('是否确认删除种子申请编号为"' + seedApplyTemporaryId + '"的数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
          return delTemporary(seedApplyIds);
        }).then(() => {
          this.getList();
