<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="temporaryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" prop="seedApplyTemporaryId" />
...
orderByColumn:"create_time",
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除种子临时申请编号为"' + seedApplyTemporaryIds + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有种子临时申请数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
