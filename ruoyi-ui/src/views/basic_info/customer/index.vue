<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="customerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" prop="customerId" />
...
<script>
import { listCustomer, getCustomer, delCustomer, addCustomer, updateCustomer, exportCustomer } from "@/api/basic_info/customer";
...
export default {
    ...
    return {
      ...
      rules: {
        ...
        customerPhone: [
          ...
          {min:11,max:11,message:"请正确输入11位电话",trigger:"blur"}
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('删除该客户会同时删除该客户的出圃信息，是否确认删除该客户?', "警告", {
    ...
    handleExport() {
      ...
      queryParams.customerIds = this.ids
      this.$confirm(`是否确认导出所选客户管理数据项?`, "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
