<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="laborList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="序号" align="center" type="index" />
      <el-table-column label="编号" align="center" prop="parameterLaborId" />
      <el-table-column label="参数名称" align="center" prop="parameterLaborName" />
      <el-table-column label="计量方式" align="center" prop="parameterMeasure" />
      <el-table-column label="参数值" align="center" prop="parameterLaborValue" />
      <el-table-column label="参数单位" align="center" prop="parameterLaborUnit" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="参数名称" prop="parameterLaborName">
          <el-input v-model="form.parameterLaborName" placeholder="请输入参数名称" />
        </el-form-item>
        <el-form-item label="计量方式" prop="parameterMeasure">
          <el-input v-model="form.parameterMeasure" placeholder="请输入计量方式" />
        </el-form-item>
        <el-form-item label="参数值" prop="parameterLaborValue">
          <el-input v-model.number="form.parameterLaborValue" placeholder="请输入参数值" />
        </el-form-item>
        <el-form-item label="参数单位" prop="parameterLaborUnit">
          <el-input v-model="form.parameterLaborUnit" placeholder="请输入参数单位" />
        </el-form-item>
...
<script>
import { listLabor, getLabor, delLabor, addLabor, updateLabor, exportLabor } from "@/api/basic_info/labor";
